          ...
          <div className="lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0 w-full mt-6">
            ...
            <div className="flex">
              ...
              {user && !loadingUser ? (
                ...
                >
                  {!message && loading && (
                    <svg
                      ...
                      className="animate-spin w-4 h-4 mx-auto my-1"
                    >
                ...
                <Link href="/login">
                  <a className="focus:outline-none hover:bg-indigo-600 flex px-6 py-2 ml-auto text-white bg-indigo-500 border-0 rounded">
                    Please login to buy
                  </a>
                </Link>
              )}
