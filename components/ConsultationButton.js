      ...
      {modal && (
        <div className="bg-opacity-90 fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full p-4 bg-black">
          ...
          <div>
            <form
              onSubmit={signup}
              className="lg:p-10 bg-gray-50 relative flex flex-col w-full max-w-screen-md p-4 mx-auto my-auto text-gray-900 rounded"
            >
              <h1 className="lg:mb-8 mb-4 text-3xl font-medium">
                Enter your detail below and we will contact you for a 15 minute
                appointment
              </h1>
              <div className="flex flex-col">
                <label className="lg:mb-4 mb-2">Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div className="flex flex-col">
                <label className="lg:mb-4 mb-2">Email Address</label>
                <input
                  type="email"
                  id="email"
                  name="email"
                  className="lg:mb-8 p-1 mb-4"
                  required
                ></input>
              </div>
              <div className="flex">
                ...
                >
                  {!message && loading && (
                    <svg
                      ...
                      className="animate-spin w-5 h-5 mx-auto my-1"
                    >
                  ...
                  {!message && !loading && "Get me started"}
                  {message && message}
                </button>
              </div>
            </form>
